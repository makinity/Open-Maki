"""Command router for dispatching parsed intents to assistant actions."""
...
# TODO: Split the handler map into smaller modules if the command set grows much larger.

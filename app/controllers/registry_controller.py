"""Business logic for app and folder registry resolution."""

from pathlib import Path
from typing import Any

from app.models.app_aliases import load_app_alias_entries
from app.models.folder_aliases import load_folder_alias_entries
